const CACHE='nishiharima-guide-v8';
const ASSETS=['./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./merrywidow-1.jpg','./merrywidow-2.jpg','./coneru-1.jpg','./coneru-2.jpg','./admin-enhance.js'];
...
self.addEventListener('fetch',e=>{
 ...
 if(e.request.mode==='navigate'){
  e.respondWith(fetch(e.request).then(async resp=>{
   ...
   html=html.replace('</body>','<script src="./admin-enhance.js?v=8"></script></body>');
